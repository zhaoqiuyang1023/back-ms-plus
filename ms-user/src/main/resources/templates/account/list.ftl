...
<div id="demo" class="layui-progress layui-hide   layui-progress-big" lay-filter="demo" lay-showPercent="true">
...
<fieldset class="layui-elem-field">
    ...
    <div class="layui-field-box">
        ...
        <button class="layui-btn layui-btn-primary" id="download">导出</button>
...
<script type="text/javascript">
    layui.use(['layer', 'laydate', 'form', 'table', 'element'], function () {
        ...
        $("#download").on("click", function () {
            ...
            down.dateStart = dateStart.trim();
            down.dateEnd = dateEnd.trim();
            down.role = role.trim();
            down.recommendable = recommendable;
            down.status = status;
            down.countryId = countryId;
            down.name = $("#accountName").val();
            ...
            if ('WebSocket' in window) {
                console.log("有websocket功能");
                let socket = new WebSocket("ws://adms.e-ports-ms.com:8080/websocket/" + sessionId);
                let index;

                socket.onopen = function () {
                    console.log("Socket 已打开");
                    $('#demo').removeClass('layui-hide');
                    index = layer.open({
                        type: 1,
                        title: false,
                        closeBtn: 0,
                ...
                socket.onmessage = function (msg) {
                    ...
                    element.progress('demo', msg.data);
                };
                //关闭事件
                ...
                console.log("Socket 不支持");
            }

            console.log(JSON.stringify(down));
            window.location.href = "${base}/account/download/" + encodeURI(JSON.stringify(down));
