                ...
                <div class="layui-col-sm1">
                    <div class="layui-inline">
                        <a class="layui-btn layui-btn-normal" id="addAnnouncement"><i
                                    class="layui-icon">&#xe654;</i>添加账号</a>
                    </div>
                    <div class="layui-inline">
                        <a class="layui-btn layui-btn-normal" id="addAomainName"><i
                                    class="layui-icon">&#xe654;</i>添加域名</a>
                    </div>
                </div>
    ...
    layui.use(['layer', 'laytpl', 'form', 'jquery', 'table', 'laydate', 'element'], function () {
        ...
        $("#addAnnouncement").on("click", function () {
            layer.open({
                ...
                type: 2,
                area: ['960px', '540px'],
                content: "${base}/forbiddenlogin/add",
                success: function () {

                }
            });
        });
        $("#addAomainName").on("click",function () {
            layer.open({
                title: "添加域名",
                type: 2,
                area: ['960px', '540px'],
                content: "${base}/forbiddenlogin/adddomain",
                success: function () {
        ...
        table.on('tool(AnnouncementTable)', function (obj) {
            ...
            if (obj.event === 'down') {
                ...
                layer.confirm("你确定吗？", {btn: ['是的,我确定', '我再想想']},
                    function () {
                        $.post("${base}/forbiddenlogin/del/" + data.id, function (res) {
                            if (res.success) {
